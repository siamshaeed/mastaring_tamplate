...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card">
      ...
      <form action="{{ route('UpdateBlog') }}" method="post" class="form-horizontal" enctype="multipart/form-data" name="editBlogForm">
        @csrf
        ...
        <div class="form-group">
          ...
          <div class="col-md-9">
            <textarea name="blog_short_description" class="form-control" id="" cols="30" rows="3">{{ $blog->blog_short_description }}</textarea>
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-md-3">Blog Long Description :</label>
          <div class="col-md-9">
            <textarea name="blog_long_description" class="form-control" id="editor" cols="30" rows="3">{{ $blog->blog_long_description }}</textarea>
          </div>
        </div>
        <div class="form-group">
